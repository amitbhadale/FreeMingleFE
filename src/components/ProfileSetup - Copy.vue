<template>
  <v-container class="d-flex justify-center align-center" style="min-height: 100vh">
    <v-card class="pa-6 elevation-12" width="600">
      ...
      <v-card-subtitle class="text-center text-subtitle-1"
        >Complete your profile to get better matches</v-card-subtitle
      >
      ...
      <v-form ref="form" @submit.prevent="handleSubmit">
        ...
        <v-text-field
          ...
          :disabled="form.mandatoryProfileSetupDone"
        ></v-text-field>
        ...
        <v-text-field
          ...
          dense
        ></v-text-field>
        <v-text-field label="Country" v-model="form.country" required outlined dense></v-text-field>
        ...
        <v-label class="font-weight-bold">What are you looking for?</v-label>
        <v-row dense>
          <v-col
            cols="6"
            v-for="option in ['Long-term', 'Marriage', 'Fun, casual dates', 'Not Sure']"
            :key="option"
          >
            <v-checkbox
              :label="option"
        ...
        <v-text-field label="Height" v-model="form.height" required outlined dense></v-text-field>

        <v-select
          label="Hobbies"
          v-model="form.hobbies"
          :items="['Gym', 'Travel', 'Reading', 'Clubbing', 'Cooking', 'Riding']"
          multiple
          chips
          outlined
          dense
        ...
        <v-select
          ...
          :items="['Confidence', 'Empathy', 'Honesty', 'Kindness', 'Ambition', 'Humor']"
          multiple
          chips
          outlined
          dense
        ...
        <v-card-actions class="justify-end">
          ...
          <v-btn type="submit" color="primary" elevation="2">Save</v-btn>
        </v-card-actions>
      </v-form>
    </v-card>
  </v-container>
